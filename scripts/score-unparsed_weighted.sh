...
# score-unparsed_weighted.sh
#
# Score a stimulus set based on whole-word or unparsed-morph phonotactics, with frequency weighting.
#
# SYNTAX: sh score-unparsed_weighted.sh <TRAIN> <STIMLIST> <LMDIR> <AUXDIR> <OUTDIR>
