...
The data is structured as follows:
  ...
  - *scoreDictNew* is the variant phonotactic score based on the dictionary training set, divided by item phonemic length; statistics for trigrams, bigrams, and unigrams are jointly included.
  - *scoreRsNew* is the variant phonotactic score based on the segmented running speech training set, divided by item phonemic length; statistics for trigrams, bigrams, and unigrams are jointly included.
  - *scoreUnsegNew* is the variant phonotactic score based on the unsegmented running speech training set, divided by item phonemic length; statistics for trigrams, bigrams, and unigrams are jointly included.
