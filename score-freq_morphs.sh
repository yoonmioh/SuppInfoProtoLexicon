...
# score-freq_morphs.sh
#
# Score a stimulus set based on core morph phonotactics, with frequency weighting.
#
# SYNTAX: sh score-freq_morphs.sh <TRAIN> <STIMLIST> <LMDIR> <AUXDIR> <OUTDIR>
