---
title: "Adults acquire a proto-lexicon from the ambient environment."
...
# Filtering out participants (Exp 1)
...
# Overview of participants’ sociolinguistic profile (Exp1)
...
# Modeling NMS' confidence ratings in all bins with a linear mixed-effects model (Exp1)
...
# Effect plots from the model presented in Table.S1 (Exp1)
...
# Mean rating and phonotactic score for each stimulus per bin (Exp1)
...
# Repaitched pairs: Mean rating and phonotactic score for each stimulus per bin (Exp1)
...
# Modeling NMS' confidence ratings with a linear mixed-effects model (rematched pairs) (Exp1)
...
# Filtering out participants (Exp2)
...
# Participants' basic Māori knowledge and proficiency (Exp2)
...
# Overview of participants' profile (Exp2)
...
# Number of participants per length within each group (Exp2)
...
# Modeling all groups' well-formedness ratings with a linear mixed-effects model (Exp2)
